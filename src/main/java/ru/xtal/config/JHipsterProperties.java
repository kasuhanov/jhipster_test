...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "yeo@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "yeo API";

        private String description = "yeo API documentation";
